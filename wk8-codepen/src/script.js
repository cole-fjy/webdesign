...
function draw(){
  ...
  for(var i=0;i<10;i++){
    ...
    ctx.fillText(pos,pos,10) //文字(內容,x,y)
  ...
  ctx.fillRect(50,200,50,150) //(x,y,寬,高)
  ctx.strokeRect(50,200,50,150) //邊線
  ...
  //右城門
  ctx.fillStyle = "#E4B165"
  ctx.fillRect(300,200,50,150) //(x,y,寬,高)
  ctx.strokeRect(300,200,50,150) //邊線
